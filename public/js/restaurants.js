//Retrieve all restaurants' basic details from database and insert into page
function RestaurantsGrid() {
    ...
    request.open("GET", "/restaurantsgrid", true);
